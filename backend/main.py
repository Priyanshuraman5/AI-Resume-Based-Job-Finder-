...
async def upload_resume(file: UploadFile = File(...)):
    ...
    try:
        ...
        raise HTTPException(status_code=400, detail="Unable to parse this resume file.") from exc
...
def get_jobs(
    ...
    return {
        ...
        "role_options": record.get("role_options") or get_role_options(record["extracted_skills"]),
    }
