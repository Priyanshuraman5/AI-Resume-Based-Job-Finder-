...
class Database:
    ...
    def save_resume_analysis(self, payload: Dict[str, Any]) -> str:
        ...
        dashboard["_search_context"] = {
            ...
            "selected_location": payload.get("selected_location", ""),
    ...
    def get_resume_analysis(self, analysis_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            with self._session_factory() as session:
                ...
                if not record:
                    return None
                search_context = (record.dashboard or {}).get("_search_context", {})
                return {
                    "id": str(record.id),
                    ...
                    "role_options": search_context.get("role_options", []),
                    "country_options": search_context.get("country_options", []),
                    "selected_country": search_context.get("selected_country", ""),
                    "selected_location": search_context.get("selected_location", ""),
                    "selected_role": search_context.get("selected_role", ""),
